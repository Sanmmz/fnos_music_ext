...
sys.path.insert(0, "/tmp/v53t/proxy")
...
src = open("/tmp/v53t/proxy/app.py", "r", encoding="utf-8").read()
...
src2 = open("/tmp/v53t/proxy/app.py", "r", encoding="utf-8").read()
...
if fails:
    ...
    sys.exit(1)
print("ALL v53 UNIT CHECKS PASSED")
